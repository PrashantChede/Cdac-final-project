...
const AdminLogin = (props) => {
    ...
    function sendLoginRequest(){
        ...
        win.setItem('firstName',response.data.firstName);
        win.setItem('adminId',response.data.id);
        console.log('id of the customer', adminId);
        console.log('name of the customer by session', win.getItem('firstName'));
        setLoginFlag(false);
        //  navigate(`/customer`);
    ...
    return (
        ...
        {loginFlag?(
            ...
            // <AdminCategory adminId={adminId}></AdminCategory>
            };
